...
def graph_search(problem, fringe):
    ...
    Añade a la pila el primer nodo del problema"""
    closed = {}
...
def branch_and_bound_graph_search(problem):
    """Search the cheapest path from current node to the next node."""
    return graph_search(problem, SortedListByCost())

# Ramificacion y acotación con subestimación

def branch_and_bound_with_understimates_graph_search(problem):
    """Search the cheapest path from current node to the goal."""
    return graph_search(problem, SortedListByHeuristicAndCost(problem))
